...
class TxnMallTest(AetherTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 ATR:
        ...
        # First: use raw transaction API to send 1240 ATR to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 ATR coin each
        ...
        # Node0's balance should be starting balance, plus 50ATR for another
        ...
        # Node0's total balance should be starting balance, plus 100ATR for
