...
By default, aetherd will dump mempool on shutdown and
...
class MempoolPersistTest(AetherTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent aetherd from writing mempool.dat to disk. Verify that `savemempool` fails")
