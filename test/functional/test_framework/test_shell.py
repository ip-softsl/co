...
class TestShell:
    """Wrapper Class for AetherTestFramework.

    The TestShell class extends the AetherTestFramework
    ...
    class __TestShell(AetherTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by AetherTestFramework child class.
            self.num_nodes = 1
