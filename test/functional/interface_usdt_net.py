...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/aether/aether/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(AetherTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our aetherd node")
