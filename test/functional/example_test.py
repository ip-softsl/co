...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AetherTestFramework
    pass


class ExampleTest(AetherTestFramework):
    # Each functional test is a subclass of the AetherTestFramework class.
    ...
    def custom_method(self):
        ...
        AetherTestFramework class so other tests can use it."""
