...
class TransactionTimeRescanTest(AetherTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine ATR and create transactions
        ...
        # generate some atr to create transactions and check blockcount
        ...
        # send 10 atr to user's first watch-only address
        self.log.info('Send 10 atr to user')
        ...
        # send 5 atr to our second watch-only address
        self.log.info('Send 5 atr to user')
        ...
        # send 1 atr to our third watch-only address
        self.log.info('Send 1 atr to user')
