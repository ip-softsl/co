...
Verify that a aetherd node can use an external signer command.
...
class RPCSignerTest(AetherTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart aetherd with -signer=<cmd>',
