Aether Core version 0.10.4 is now available from:

  <https://aether.org/bin/aether-core-0.10.4/>
...
- #6953 `43c2789` Split aether-tx into its own package
- #6953 `dfe0d4d` Include aether-tx binary on Debian/Ubuntu
