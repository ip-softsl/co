Aether Core version *0.15.2* is now available from:

  <https://aethercore.org/bin/aether-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in aether-tx (TheBlueMatt)
