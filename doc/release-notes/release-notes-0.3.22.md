Download URL: https://sourceforge.net/projects/aether/files/Aether/aether-0.3.22/
...
Notable changes:
* Client will accept and relay TX's with 0.0005 ATR fee schedule (users still pay 0.01 ATR per kb, until next version)
...
* IRC is overflowing.  Client now bootstraps to channels #aether00 - #aether99
