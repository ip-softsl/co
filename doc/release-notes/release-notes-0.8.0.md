Aether-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/aether/files/Aether/aether-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Aether
...
New/changed settings (command-line or aether.conf file)
--------------------------------------------------------
