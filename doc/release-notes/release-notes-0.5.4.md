Aether version 0.5.4 is now available for download at:
http://sourceforge.net/projects/aether/files/Aether/aether-0.5.4/
...
http://gitorious.org/aether/aetherd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Aether-Qt notifications under Growl 1.3.
Increase required age of Aether-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxAether properly when installing Aether-Qt over it. (Windows)
