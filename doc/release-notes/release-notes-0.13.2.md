Aether Core version 0.13.2 is now available from:

  <https://aether.org/bin/aether-core-0.13.2/>
...
- #8908 `4a974b2` Update aether-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow aether-tx to create v2 transactions (atrdrak)
