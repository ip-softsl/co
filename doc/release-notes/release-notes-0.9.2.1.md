Aether Core version 0.9.2.1 is now available from:

  https://aether.org/bin/0.9.2.1/
...
- Lower paytxfee warning threshold from 0.25 ATR to 0.01 ATR
...
- Fix "Start aether on system login"
