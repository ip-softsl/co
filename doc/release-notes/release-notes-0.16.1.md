Aether Core version 0.16.1 is now available from:

  <https://aethercore.org/bin/aether-core-0.16.1/>
...
- #12843 `df38b13` Test starting aetherd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure aetherd processes are cleaned up when tests end (sdaftuar)
