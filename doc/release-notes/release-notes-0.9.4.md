Aether Core version 0.9.4 is now available from:

  https://aether.org/bin/0.9.4/
...
this update is incompatible with the Aether system and could lead to consensus
forks.

Aether Core released binaries from https://aether.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~aether/+archive/ubuntu/aether
- A third-party or self-compiled Aether Core

upgrade to Aether Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
