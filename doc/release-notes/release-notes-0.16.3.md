Aether Core version 0.16.3 is now available from:

  <https://aethercore.org/bin/aether-core-0.16.3/>
...
been discovered in Aether Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` aetherconsensus: invalid flags error should be set to `aetherconsensus_err` (afk11)
