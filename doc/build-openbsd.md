...
This guide describes how to build aetherd, command-line utilities, and GUI on OpenBSD.
...
...
to: /path/to/aether/depends/x86_64-unknown-openbsd
```

Then set `BDB_PREFIX`:

```bash
export BDB_PREFIX="/path/to/aether/depends/x86_64-unknown-openbsd"
```

#### GUI Dependencies
###### Qt5

Aether Core includes a GUI built with the cross-platform Qt Framework. To compile the GUI, Qt 5 is required.
...
(see issue [#6658](https://github.com/aether/aether/issues/6658)).
