...
This document provides guidelines for internationalization of the Aether Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `aether_en.ts` remains unchanged.
