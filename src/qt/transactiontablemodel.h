...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, AetherUnits::SeparatorStyle separators=AetherUnits::SeparatorStyle::STANDARD) const;
