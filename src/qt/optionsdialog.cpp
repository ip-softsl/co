      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->aetherAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->aetherAtStartup);
    ...
    ui->aetherAtStartup->setToolTip(ui->aetherAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->aetherAtStartup->setText(ui->aetherAtStartup->text().arg(PACKAGE_NAME));

    ui->openAetherConfButton->setToolTip(ui->openAetherConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new AetherUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->aetherAtStartup, OptionsModel::StartAtStartup);
    ...
    mapper->addMapping(ui->m_enable_psbt_controls, OptionsModel::EnablePSATRontrols);
...
void OptionsDialog::on_openAetherConfButton_clicked()
{
