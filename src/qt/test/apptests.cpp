...
//! Entry point for AetherApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &AetherApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for AetherGUI tests.
void AppTests::guiTests(AetherGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &AetherGUI::consoleShown, this, &AppTests::consoleTests);
