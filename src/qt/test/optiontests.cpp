...
{
    // Test regression https://github.com/aether/aether/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/aether-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/aether-core/gui/pull/568.
    // With fListen=false in ~/.config/Aether/Aether-Qt.conf and all else left as default,
    // aether-qt should set both -listen and -listenonion to false and start successfully.
