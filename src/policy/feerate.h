...
const std::string CURRENCY_UNIT = "ATR"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    ATR_KVB,      //!< Use ATR/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::ATR_KVB) const;
