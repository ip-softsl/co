...
{
    BOOST_CHECK(TestSplitHost("www.aethercore.org", "www.aethercore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.aethercore.org]", "www.aethercore.org", 0));
    BOOST_CHECK(TestSplitHost("www.aethercore.org:80", "www.aethercore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.aethercore.org]:80", "www.aethercore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.aethercore.org:65536", "www.aethercore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.aethercore.org:0", "www.aethercore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.aethercore.org:", "www.aethercore.org:", 0, false));
}
