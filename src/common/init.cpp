// Copyright (c) 2023 The Aether Core developers
...
std::optional<ConfigError> InitConfig(ArgsManager& args, SettingsAbortFn settings_abort_fn)
{
    try {
        ...
        // aether.conf file just ignores the other file.)
        ...
        if (!fs::exists(base_path)) {
            ...
            // in https://github.com/aether/aether/issues/16220 about ways to
        ...
        // Show an error or warning if there is a aether.conf file in the
