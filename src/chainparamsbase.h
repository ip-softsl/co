// Copyright (c) 2014-2020 The Aether Core developers
...
/**
 * CBaseChainParams defines the base parameters (shared between aether-cli and aetherd)
 * of a given instance of the Aether system.
 */
