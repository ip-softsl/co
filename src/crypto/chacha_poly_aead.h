// Copyright (c) 2019-2021 The Aether Core developers
...
/* A AEAD class for ChaCha20-Poly1305@aether.
 *
 ...
 *
 * The chacha20-poly1305@aether combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@aether cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@aether are relatively fast in
