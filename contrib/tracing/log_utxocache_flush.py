...
"""Example logging Aether Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/aetherd
...
def main(aetherd_path):
    ...
    b = BPF(text=program, usdt_contexts=[aetherd_with_usdts])
