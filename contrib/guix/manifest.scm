...
(define* (make-aether-cross-toolchain target
                                       #:key
...
desirable for building Aether Core release binaries."
...
;; failure; see https://github.com/aether/aether/pull/27296.
  ...
  (let ((target (getenv "HOST")))
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (make-aether-cross-toolchain target)))
