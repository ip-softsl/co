...
complete --command aetherd --no-files

# Extract options
function __fish_aetherd_get_options
...
complete \
    --command aetherd \
    --arguments "(__fish_aetherd_get_options --nofiles)"
