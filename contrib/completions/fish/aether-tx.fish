...
# Extract options
function __fish_aether_tx_get_options
...
# Extract commands
function __fish_aether_tx_get_commands
...
complete \
    --command aether-tx \
    --condition "not __fish_aether_seen_cmd (__fish_aether_tx_get_commands --commandsonly)" \
    --arguments "(__fish_aether_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command aether-tx \
    --arguments "(__fish_aether_tx_get_commands)" \
    --no-files
