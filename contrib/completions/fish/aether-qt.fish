...
complete --command aether-qt --no-files

# Extract options
function __fish_aetherqt_get_options
...
complete \
    --command aether-qt \
    --arguments "(__fish_aetherqt_get_options --nofiles)"
